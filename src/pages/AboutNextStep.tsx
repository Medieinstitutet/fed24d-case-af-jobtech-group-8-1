      ...
      >
        ...
        <DigiTypography>
          <p style={{ maxWidth: 900 }}>
            Vi samlar riktiga platsannonser och lyfter fram alternativ för dig i
            början av karriären. Med öppna API:er, tydliga urval och ett
            tillgängligt designsystem vill vi göra jobbsökandet enklare, mer
        ...
        <DigiList
          ...
          style={{ maxWidth: 900, lineHeight: 1.6, marginTop: "0.5rem" }}
        >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p>
                Börja brett och smalna av. Kombinera yrkesord med ort/område. Testa
                synonymer och engelska termer (t.ex. "internship"). Spara
                sökningar du ofta använder.
              </p>
            </DigiInfoCard>
            ...
            >
              <p>
                Lyft motivation, relevanta kurser och projekt. Anpassa rubrik och
                inledning efter roll. Kort, tydligt och fokuserat vinner ofta.
              </p>
            </DigiInfoCard>
        ...
        >
          ...
          >
            ...
            >
              <p>
                Var tydlig med period, omfattning och mål. Beskriv vad du vill
                lära dig och hur du kan bidra. Koppla till utbildningens innehåll.
              </p>
            </DigiInfoCard>
            ...
            >
              <p>
                Jämför upplägg (rotation, mentorskap, utbildningstimmar) och datum.
                Håll koll på kvalifikationskrav och ansökningsfönster.
              </p>
            </DigiInfoCard>
